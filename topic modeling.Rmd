...
Emantic Validation of the topics:
...
```{r}
11713+ 64264+ 2390+ 3534 + 12548+ 89+ 18535+ 5181+ 24334+ 46922 
```


```{r}
theta_matrix <- stmodel$theta
topic_10_proportions <- theta_matrix[, 10]  # Replace 4 with the desired topic number
sorted_documents <- order(topic_10_proportions, decreasing = TRUE)
```

```{r}
num_documents_to_retrieve <- 10  # Adjust this number as needed
top_documents <- combined$Comments[sorted_documents[1:num_documents_to_retrieve]]
```
